...
export default function CustomerLoginPage() {
  ...
  React.useEffect(() => {
    ...
    const cb = sp.get("callbackUrl") || "/account";
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-(--brand-primary) relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white w-full">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4 max-w-md">
              <div className="rounded-xl bg-white/10 backdrop-blur-sm p-4">
                ...
                <p className="text-sm opacity-70">Fragrances available</p>
              </div>
              <div className="rounded-xl bg-white/10 backdrop-blur-sm p-4">
                <p className="text-2xl font-bold">24h</p>
                <p className="text-sm opacity-70">Fast delivery</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-sm opacity-70">
            New to Abby&apos;s Corner?{" "}
            <Link href="/register" className="underline hover:opacity-100">
              Create an account
            </Link>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 bg-(--brand-light) flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-6 pb-12">
          <div className="w-full max-w-sm">
            ...
            {/* Register link */}
            <p className="text-center text-sm text-(--brand-primary)/60">
